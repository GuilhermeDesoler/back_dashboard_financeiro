            ...
            jsonify(
                {
                    ...
                    "endpoints": {
                        ...
                        "admin": {
                            ...
                            "audit_logs": "GET /api/admin/audit-logs (super admin only)",
                        },
                        "payment_modalities": {
                    ...
                    "database_architecture": {
                        "shared_db": ["companies", "users", "features", "audit_logs"],
                        "per_company_db": [
                            "financial_entries",
                            "payment_modalities",
                            "roles",
...
if __name__ == "__main__":
    debug_mode = env.get("ENVIRONMENT", "development") == "development"
